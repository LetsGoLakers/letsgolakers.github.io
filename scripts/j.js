...
for (frt of args) {
    qst = qry(frt);
    console.log("I am frt " + frt)
    console.log( " I am qst ");
    console.log(qst)
    ...
    if (qst.s) {
        if (typeof rpt == 'undefined') {
            ...
            console.log("I am rpt " + rpt);
            eval(rpt);
            
            fcnm = rpt.match(/signature\W+(\w+)/)[1];
            console.log("I am fcnm " + fcnm);
        }
        console.log("I am hrf " + hrf)
        console.log(sprintf('%s("%s")', fcnm, qst.s))
